...
alias q=exit
alias cdabq='cd ~/Research/ABQ/scripts'
alias cdhusl='cd ~/Research/HUSL'
alias cddyn='cd ~/Classes/AERO\ 622\ \(Dynamics\)'
alias cdest='cd ~/Classes/AERO\ 626\ \(Estimation\)'
alias tmat='matlab -nodesktop -nosplash'
alias cdh='cd ~/HUSLSVN/HUSL_Software/Helicopter_Simulator'
alias cdauto='cd ~/Research/HUSL/Autorotation'
alias cdmp='cd /home/zach/HUSLSVN/ACM/mavlink/MAVProxy-master'
...
PATH=$PATH:/home/zach/Scripts:/usr/local/cuda/bin
export PATH
