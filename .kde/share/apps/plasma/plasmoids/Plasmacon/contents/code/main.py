...
class Plasmacon(plasmascript.Applet):
    ...
    def initWithTabs(self):
        self.applet.setMinimumSize(300, 155)
        self.hlayout = QGraphicsLinearLayout(Qt.Vertical, self.applet)
        ...
        spacer = Plasma.Label(self.applet)
        ...
        self.applet.setLayout(self.hlayout)
    ...
    def initWithoutTabs(self):
        self.applet.setMinimumSize(280, 55)
        self.groupBox = Plasma.GroupBox(self.applet)

        self.appletLayout = QGraphicsLinearLayout(Qt.Vertical, self.applet)        
        ...
        self.applet.setLayout(self.appletLayout)
        self.startSingleSession()
